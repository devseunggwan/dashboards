...
class NftCurationUI:
    ...
    def get_collection_ranking(_self, network, period: str = "1d", sortby: str = "volume"):
        params = {
            "period": period,
            "sortBy": sortby,
            "limit": 100,
    ...
    def st_sidebar(self):
        with st.sidebar:
            ...
            network = st.selectbox("Network", list(self.reservoir_networks_url_prefix.keys()))
    ...
    def st_ranking(self):
        ...
        with col_network:
            ranking_network = st.selectbox("Select Network", list(self.reservoir_networks_url_prefix.keys()))
        ...
        ranking = self.get_collection_ranking(ranking_network, period=period, sortby=sortby)
